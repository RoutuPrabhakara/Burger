...
<section className='order'>
  <div className="order-left">
      ...
      <div className='Burger-club-h1'>
                <h3>The Buger Club Rajpuri <br />Garden Delhi</h3>
      </div>
      </div>
      <div className='Burger-club-para'>
                        <p>Z9 First Floor Naziabad 9, NajafGharkh  Rd <br />Block j,Rajpuri Garden</p>
      </div>
      <div className='Burger-club-ul'>
                  <ul>
                  <li><i class="bi bi-geo-alt-fill"></i> Rajpuri Garden Delhi</li>
                  <li><i class="bi bi-alarm"></i> 40 mins Delivery Time</li>
                  <li><i class="bi bi-telephone"></i> 113578234</li>
                  <li><i class="bi bi-star"></i> 3.6(10Ratings)</li>
                  </ul>
                  <hr />
      </div>
      ...
      <div className='Business-para'>
              <h5>BUGER CLUB PRIVATE LIMITED</h5>
      </div>
      <div className='fassai-num'>
                <h4>1234567890</h4>
      </div>
      <div className='Business-button'>
                <a href=""><button><i class="bi bi-telephone"></i>  Call</button></a>
                <a href=""><button className='Button-Name'>Order Now</button></a>
      </div>
      </div>
      </div>
  </div>
  <div className="order-middle">
    ...
    <h3>The Burger Club Rajouri Garden Delhi Menu <br />and Address Details</h3>
    </div>
...
<h3>Outlet Rating</h3>
  ...
  <div className='Outlet-imgages'>
  <img src="https://www.uengage.in/images/addo/logos/logo-29124-1689661084.png" alt=""  className='logo'/>

<div>
<h3>The Burger Club</h3>
<img src="https://theburgerclub.in/assets/wla_new/img/location.png" alt="" />
</div>

<h3>Rajouri  Garden Delhi</h3>
...
<div className='order-right-menu'>
<h3>We Are Located At</h3>
<hr />
</div>
<div className='order-table'>
<div className='order-right-menu-1'>
<h4>A</h4>
<button>Amritsar</button>
</div>
<div className='order-right-menu-2'>
<h4>D</h4>
<button>Delhi</button>
</div>
<div className='order-right-menu-3'>
<h4>F</h4>
...
<div className='order-right-menu-4'>
<h4>N</h4>
<button>Noida</button>
</div>
</div>
